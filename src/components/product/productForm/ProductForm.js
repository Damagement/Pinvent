      ...
      <Card cardClass={"card"}>
        <form onSubmit={saveProduct}>
          ...
          <input type="text" name="quantity" placeholder='Product Quantity' value={product?.quantity} onChange={handleInputChange}/>
           ...
           <ReactQuill theme='snow' value={description} onChange={setDescription} modules={ProductForm.modules} format={ProductForm.formats} />
